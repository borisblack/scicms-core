...
class DataProps {
    ...
    var permissionIdsCacheExpirationMinutes: Long = DEFAULT_PERMISSION_CACHE_EXPIRATION_MINUTES

    companion object {
        private const val DEFAULT_LIMIT = 25
        private const val MAX_LIMIT = 5
        private const val DEFAULT_ITEM_CACHE_EXPIRATION_MINUTES: Long = 1440
        private const val DEFAULT_PERMISSION_CACHE_EXPIRATION_MINUTES: Long = 10
    }
}