...
class LifecycleManagerImpl(
    ...
    override fun assignLifecycleAttributes(item: Item, prevItemRec: ItemRec, itemRec: ItemRec) {
        var lifecycleId = itemRec.lifecycle
        val allowedLifecycles = allowedLifecycleCache[item.name]
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(LifecycleManagerImpl::class.java)
    }
}