...
class LiquibaseColumns {
    fun list(item: Item): List<ColumnConfig> = item.spec.attributes.asSequence()
    ...
    private fun primaryKeyConstraintName(tableName: String, columnName: String) = "${tableName}_${columnName}_pk"
    ...
    fun dropColumnChange(tableName: String, columnName: String): DropColumnChange = DropColumnChange().apply {
    ...
    fun dropDefaultValueChange(tableName: String, columnName: String): DropDefaultValueChange = DropDefaultValueChange().apply {
        this.tableName = tableName
        this.columnName = columnName
    }
    ...
    fun dropPrimaryKeyChange(tableName: String, columnName: String): DropPrimaryKeyChange = DropPrimaryKeyChange().apply {
        this.tableName = tableName
        this.constraintName = primaryKeyConstraintName(tableName, columnName)
    }

    fun addPrimaryKeyChange(tableName: String, columnName: String): AddPrimaryKeyChange = AddPrimaryKeyChange().apply {
        this.tableName = tableName
