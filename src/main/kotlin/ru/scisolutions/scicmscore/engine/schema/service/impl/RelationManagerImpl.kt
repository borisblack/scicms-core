...
class RelationManagerImpl(
    ...
    override fun getAttributeRelation(item: Item, attrName: String, attribute: Attribute): Relation {
        relationValidator.validateAttribute(item, attrName, attribute)

        return when (attribute.relType) {
            RelType.oneToOne -> getOneToOneAttributeRelation(item, attrName, attribute)
            RelType.manyToOne -> getManyToOneAttributeRelation(item, attrName, attribute)
            RelType.oneToMany -> getOneToManyAttributeRelation(item, attrName, attribute)
            RelType.manyToMany ->getManyToManyAttributeRelation(item, attrName, attribute)
