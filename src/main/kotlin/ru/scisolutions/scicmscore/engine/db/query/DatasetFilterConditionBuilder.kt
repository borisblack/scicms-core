...
import ru.scisolutions.scicmscore.schema.model.relation.*
...
class DatasetFilterConditionBuilder {
    fun newFilterCondition(
        ...
        datasetFilterInput.attributeFilters.forEach { (attrName, attrFilter) ->
        ...
        datasetFilterInput.andFilterList?.let { list ->
        ...
        datasetFilterInput.orFilterList?.let { list ->
        ...
        datasetFilterInput.notFilter?.let {
