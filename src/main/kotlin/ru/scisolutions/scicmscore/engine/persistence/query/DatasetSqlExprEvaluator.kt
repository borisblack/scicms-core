...
class DatasetSqlExprEvaluator {
    ...
    fun calculateType(columns: Map<String, Column>, input: DatasetFieldInput): FieldType {
        if (input.aggregate == null) {
            return if (input.formula == null) {
                ...
                FieldType.decimal // TODO: Infer type from expression
            }
        }
    ...
    fun calculateAggregationResultType(type: FieldType, aggregationType: AggregateType): FieldType = when (aggregationType) {
