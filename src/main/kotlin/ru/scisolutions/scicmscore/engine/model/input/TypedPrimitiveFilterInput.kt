...
class TypedPrimitiveFilterInput(
    ...
    companion object {
        fun fromMap(attrType: FieldType, filters: Map<String, Any>, opPrefix: String = ""): TypedPrimitiveFilterInput =
            TypedPrimitiveFilterInput(
                attrType = attrType,
