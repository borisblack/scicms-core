...
class DatasetFilterInput(
    ...
    andFilterList: List<DatasetFilterInput>?,
    ...
    companion object {
        ...
        private const val OR_KEY = "\$or"
        private const val NOT_KEY = "\$not"

        fun fromMap(filters: Map<String, Any>): DatasetFilterInput = DatasetFilterInput(
