...
class DatasourceItemRec(map: MutableMap<String, Any?> = mutableMapOf()) : ItemRec(map) {
    var connectionString: String?
        ...
        set(value) { this[CONNECTION_STRING_ATTR_NAME] = value }
    ...
    var maxPoolSize: Int?
        ...
        set(value) { this[MAX_POOL_SIZE_ATTR_NAME] = value }

    var minIdle: Int?
        get() = this[MIN_IDLE_ATTR_NAME] as Int?
        set(value) { this[MIN_IDLE_ATTR_NAME] = value }

    var params: Map<*, *>?
        get() = this[PARAMS_ATTR_NAME] as Map<*, *>?
        set(value) { this[PARAMS_ATTR_NAME] = value }
