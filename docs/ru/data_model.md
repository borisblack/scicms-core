...
Архитектура SciCMS Core предполагает хранение метаданных (всей информации, необходимой для работы системы) в основной реляционной базе данных, которая называется `main`.
...
После создания, источник данных может быть использован любо в определении сущности по его имени.
